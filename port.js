const navbar = document.querySelector('.navbar');
     ...
     //speech about code
     let utterance = new SpeechSynthesisUtterance("hello my friend my name is babu ali and this is my personal portfolio website. i am a student and i amd a full stack web devloper and Ui and ux designer.if you want to contact me you can contact me through this website thansks");
     function speakstart(){
         speechSynthesis.speak(utterance);
        
     }
    // Al
    let ai = new SpeechSynthesisUtterance("Artificial Intelligent is feature");
     function aistart(){
...
// Username : "desigameryt2022@gmail.com",
// Password : "039D52D97ED61722E96955D4D11134A7233F",
SecureToken : "896ec618-c3fc-438c-9b45-fd75a2eea898",
To : 'babualitmu@gmail.com',
From : "dynamicstudy2022@gmail.com",
Subject : "Mail From Contact Form",
Body : " Full Name:" + document.getElementById("form-name").value + "<br/> <br/> Phone-Number:" + document.getElementById("form-phone").value + " <br/> <br/> Email:" 
+ document.getElementById("contact-email").value + "<br/> <br/> Message:" + document.getElementById("message-control").value
}).then(
